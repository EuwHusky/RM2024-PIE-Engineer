...
#define JOINT_1_HOMING_ANGLE (-6.6f)

#define JOINT_2_START_ANGLE (90.0f)

#define JOINT_3_START_ANGLE (175.0f)

#define JOINT_4_HOMING_STEP_ANGLE (0.5f)
#define JOINT_4_HOMING_TORQUE_THRESHOLD (1.0f)
#define JOINT_4_HOMING_ANGLE (0.0f)
#define JOINT_4_START_ANGLE (0.0f)

#define JOINT_5_HOMING_STEP_ANGLE (0.5f)
#define JOINT_5_HOMING_TORQUE_THRESHOLD (1.0f)
#define JOINT_5_HOMING_ANGLE (0.0f)
