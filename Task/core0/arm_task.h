...
#define ENGINEER_ARM_JOINT_4_RM_M3508_ANGLE_PID_KP (1.0f)
#define ENGINEER_ARM_JOINT_4_RM_M3508_ANGLE_PID_KI (0.0f)
#define ENGINEER_ARM_JOINT_4_RM_M3508_ANGLE_PID_KD (0.0f)
...
#define ENGINEER_ARM_JOINT_4_RM_M3508_SPEED_PID_KI (12.0f)
...
#define ENGINEER_ARM_JOINT_56_RM_M2006_ANGLE_PID_KP (2.0f)
...
// 磁编码器安装偏差
#define ENGINEER_ARM_JOINT_4_ENCODER_ANGLE_OFFSET (-122.0f)
