...
#define ENGINEER_GIMBAL_YAW_RM_M2006_ANGLE_PID_KP (0.48f)
...
#define ENGINEER_GIMBAL_YAW_RM_M2006_SPEED_PID_KP (1400.0f)
#define ENGINEER_GIMBAL_YAW_RM_M2006_SPEED_PID_KI (0.5f)
