...
#define GIMBAL_YAW_HOMING_TORQUE_THRESHOLD (4.2f)
#define GIMBAL_YAW_HOMING_ANGLE (78.4f)
...
#define ENGINEER_GIMBAL_YAW_RM_M2006_ANGLE_PID_KP (0.4f)
#define ENGINEER_GIMBAL_YAW_RM_M2006_ANGLE_PID_KI (0.0f)
#define ENGINEER_GIMBAL_YAW_RM_M2006_ANGLE_PID_KD (0.0f)
#define ENGINEER_GIMBAL_YAW_RM_M2006_ANGLE_PID_MAX_IOUT (0.0f)
#define ENGINEER_GIMBAL_YAW_RM_M2006_ANGLE_PID_MAX_OUT (16.0f)
#define ENGINEER_GIMBAL_YAW_RM_M2006_SPEED_PID_KP (1250.0f)
#define ENGINEER_GIMBAL_YAW_RM_M2006_SPEED_PID_KI (0.25f)
