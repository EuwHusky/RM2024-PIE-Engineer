...
#define PM_UART_TX_DMA_CHN (3U)
#define PM_UART_TX_DMAMUX_CHN DMA_SOC_CHN_TO_DMAMUX_CHN(BOARD_HDMA, PM_UART_TX_DMA_CHN)
#define PM_UART_TX_DMA_REQ HPM_DMA_SRC_UART3_TX
/* 图传裁判系统UART相关 */
...
#define BOARD_UART6_TX_DMA_CHN (4U)
#define BOARD_UART6_TX_DMAMUX_CHN DMA_SOC_CHN_TO_DMAMUX_CHN(BOARD_XDMA, BOARD_UART6_TX_DMA_CHN)
